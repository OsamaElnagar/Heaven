<div class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8" dir="rtl">
    <div class="mb-8 text-center">
        <flux:heading size="xl">العروض المميزة</flux:heading>
        <p class="mt-2 text-zinc-600 dark:text-zinc-400">أفضل العروض والأسعار لموسم {{ date('Y') }}</p>
    </div>
    ...
    @if ($packages->isEmpty())
        <div class="rounded-xl border border-dashed border-zinc-300 py-16 text-center dark:border-zinc-600">
            ...
            <p class="mt-4 text-lg text-zinc-500 dark:text-zinc-400">لا توجد عروض مميزة متاحة حالياً</p>
        </div>
    @else
